...
function DealCarousel({ title, eyebrow, deals, image, onBook }) {
  ...
  const scroll = (direction) => {
    ...
    const gap =
      Number.parseFloat(window.getComputedStyle(rail).columnGap) || 0;
  ...
  return (
    <section className="deal-section">
      <div className="deal-heading">
        ...
        <div className="deal-controls">
          <button
            type="button"
            onClick={() => scroll(-1)}
            aria-label={`Xem ${title} phía trước`}
          >
          ...
          >
            <div
              ...
              style={{
                ...
                backgroundPosition: deal.position,
              }}
            >
              <span className="deal-rank">
                {String(index + 1).padStart(2, "0")}/{deals.length}
              </span>

              {deal.country && (
                <span className="deal-country">
                  {deal.country}
                </span>
              )}
              ...
              <div className="deal-gradient">
                ...
                <div className="deal-price">
                  <small>Từ</small>
                  <strong>{deal.price} VND*</strong>
                  <span>
                    {deal.seen || "Khứ hồi · Economy"}
                  </span>
                </div>
              </div>
            </div>
      ...
      <p className="deal-note">
        *Giá vé tham khảo được cập nhật trong 48 giờ gần nhất và có thể thay
        đổi tại thời điểm đặt chỗ.
      </p>
    </section>
  );
}
...
function HomePage() {
  ...
  const fromSug = useMemo(() => {
    ...
    const matched = allAirports.filter(
      (ap) =>
    ...
    // Nếu nhập sai hoặc nhập dư ký tự khiến không còn kết quả,
    // vẫn giữ danh sách sân bay để người dùng chọn lại.
    if (matched.length === 0) {
      return allAirports.slice(0, VISIBLE_LIMIT);
    }
  ...
  const onFromChange = (val) => {
    ...
    // Khi người dùng bắt đầu nhập lại,
    // lựa chọn sân bay trước đó không còn được giữ.
    setFromAirport(null);

    // Luôn giữ dropdown mở kể cả nhập sai hoặc nhập quá 3 ký tự.
    setShowFromSug(true);
    setExpanded(true);
 ...
 const handleSearch = () => {
  const fromCode = fromAirport?.maSanBay || "";
  const toCode = toAirport?.maSanBay || "";

  // Không chọn điểm đi và điểm đến
  // -> chuyển sang trang Mua vé như chức năng trên navbar
  if (!fromCode && !toCode) {
  ...
  return (
    <div className="home-page">
      <main className="home-main">
              ...
              <div className="booking-field">
                ...
                <input
                  ...
                  onFocus={() => {
                    ...
                    // Click lại vào ô luôn mở danh sách,
                    // không phụ thuộc số ký tự đang nhập.
                    setShowFromSug(true);
        ...
        <section
          className="travel-stories"
          id="travel-stories"
        >
          <div className="deal-heading">
            <div>
              <span>Cảm hứng hành trình</span>
              <h2>Cẩm nang du lịch mới nhất</h2>
            </div>

            <a href="#travel-stories">
              Xem tất cả
              <MaterialIcon name="arrow_forward" />
            </a>
          </div>
          ...
          <div className="story-grid">
            {[
              {
                slug: "48-gio-kham-pha-ha-noi",
                tag: "Ẩm thực",
                title:
                  "48 giờ ăn và khám phá Hà Nội như một người bản địa",
                time: "6 phút đọc",
                position: "0% 0%",
                image: vietnamDestinations,
              },
              {
                slug: "bi-quyet-san-ve-quoc-te",
                tag: "Kinh nghiệm",
                title:
                  "Bí quyết săn vé tốt cho chuyến đi quốc tế đầu tiên",
                time: "8 phút đọc",
                position: "66.666% 0%",
                image: internationalDestinations,
              },
              {
                slug: "mua-hoa-anh-dao-nhat-ban",
                tag: "Điểm đến",
                title:
                  "Mùa hoa anh đào Nhật Bản: đi đâu và vào thời điểm nào?",
                time: "5 phút đọc",
                position: "0% 0%",
                image: internationalDestinations,
              },
          ...
          <div className="bento-grid">
            <div className="bento-item bento-main">
              ...
              <div className="bento-overlay">
                ...
                <p>
                  Sự sang trọng và riêng tư tuyệt đối
                  trên mọi hành trình quốc tế.
                </p>
        ...
        <section className="newsletter">
          <div className="newsletter-content">
            ...
            <p>
              Nhận thông tin ưu đãi mới nhất và tin tức
              du lịch từ Vietnam Airlines.
            </p>
            ...
            <label className="newsletter-check">
              ...
              <span>
                Tôi đồng ý với Chính sách bảo mật và
                Điều khoản sử dụng
              </span>
            </label>
          </div>
        ...
        <footer className="footer">
          ...
          <div className="footer-bottom">
            <p>
              &copy; 2024 Vietnam Airlines JSC.
              All rights reserved.
            </p>
